...
############# TODO0 ###############
# Ustaw ścieżki
test_rgb = os.path.join(os.path.abspath(''), "test_rgb")  # Ścieżka do foldeu test_rgb
test_thermal = os.path.join(os.path.abspath(''), "test_thermal")  # Ścieżka do foldeu test_thermal
###################################
...
for i in range(200, 518): # można zmieniać range do 518
